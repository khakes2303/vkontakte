...
<div class="col-8 mx-auto">
	<div class="row">
		...
		<?php 
			...
			$query = mysqli_query($con, "SELECT * FROM users WHERE id={$_SESSION['lol']}");
		...
		<div class="col-7 pt-3">
			...
			<p class="text-secondary ml-3 pt-3">Город: <?php echo $stroka["city"] ?></p>
			<p class="text-secondary ml-3">Образование: <?php echo $stroka["education"] ?></p>
		</div>
	</div>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
		...
		<form>	
			<input type="file" method="POST" enctype="multipart/form-data" action="updatePhoto.php"  placeholder="Выбрать файл">
